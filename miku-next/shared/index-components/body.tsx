    ...
    <>
      <Center>
        <VStack spacing={25} mx={150} align="center">
          <Text fontSize="4xl" align="center" color="white" pt={65}>
            The Multipurpose Bot made to be simple
          </Text>
        </VStack>
      </Center>
        ...
        <HStack align="center" justify="center" spacing={150} pt={75} mx={50}>
          <Container>
            ...
            <Text align="center" pt={25} mx={15}>
              Miku offers a web dashboard (coming soon), and commands to
          ...
          <Container>
            ...
            <Text align="center" pt={25} mx={15}>
              Miku offers an economy where users can auction items, and compete
              for the richest user
            </Text>
          </Container>
          <Container>
            <Center pb={25}>
